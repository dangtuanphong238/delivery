...
class Dialog extends Component {
  ...
  constructor(props: DialogType) {
    ...
    (this: any).hardwareBackEventHandler = this.hardwareBackEventHandler.bind(
      this,
    );
  }
  ...
  // UNSAFE_componentWillReceiveProps(nextProps: DialogType) {
  ...
  setDialogState(toValue: number, callback?: Function = () => {}) {
    ...
    this.timeoutId = setTimeout(() => {
      ...
      !!toValue && this.setState({ dialogState });
      callback();
